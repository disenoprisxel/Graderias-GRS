...
const proyectos: Proyecto[] = [
  ...
  {
    titulo: 'Venta de Silletería — Estadio de Béisbol de Sincelejo',
  ...
  {
    titulo: 'Copa Davis 2019 — Colombia vs Turquía',
  ...
  {
    titulo: 'Juegos Centroamericanos y del Caribe — Mar y Playa — Santa Marta',
