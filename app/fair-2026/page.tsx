...
export const metadata: Metadata = {
  title: 'F-AIR 2026 | Graderías GRS',
  description:
    'Montaje de graderías para F-AIR 2026, la Feria Aeronáutica Internacional de Colombia celebrada en el Centro de Exposiciones Corferias. Graderías GRS fue la empresa encargada de las estructuras para este evento de talla mundial.',
}
...
export default function Page() {
  return (
    <ProyectoPage
      ...
      descripcionLarga={[
        'Graderías GRS fue la empresa encargada del montaje de graderías para F-AIR 2026, la Feria Aeronáutica Internacional de Colombia, uno de los eventos de aviación más importantes de América Latina. El certamen reunió a miles de visitantes y profesionales de la industria aeronáutica en las instalaciones de Corferias, Bogotá.',
