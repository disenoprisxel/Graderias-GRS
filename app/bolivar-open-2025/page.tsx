...
export const metadata: Metadata = {
  title: 'Seguros Bolívar Open 2025 | Graderías GRS',
  description:
    'Montaje de graderías para el Seguros Bolívar Open 2025, torneo de tenis realizado en el Club Los Lagartos de Bogotá. Graderías GRS proveyó las estructuras para los espectadores del evento.',
}
...
export default function Page() {
  return (
    <ProyectoPage
      titulo="Seguros Bolívar Open 2025"
      ...
      descripcionLarga={[
        'Graderías GRS fue la empresa encargada del montaje de graderías para el Seguros Bolívar Open 2025, uno de los torneos de tenis más importantes del circuito nacional, celebrado en las instalaciones del Club Los Lagartos en Bogotá.',
      ...
      datos={[
        ...
        { label: 'Patrocinador',    valor: 'Seguros Bolívar' },
